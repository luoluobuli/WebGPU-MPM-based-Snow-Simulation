...
const BASE_PARTICLE_RADIUS: f32 = 0.05;
const OVERLAP_FACTOR: f32 = 1.5;
...
fn vert(
    ...
    let radius = BASE_PARTICLE_RADIUS * OVERLAP_FACTOR;
    out.radius = radius;
    ...
    let vertex_pos_world = particle.pos + (right * uv.x + up * uv.y) * radius;
